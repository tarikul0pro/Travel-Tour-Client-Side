...
const ManageBooking = () => {
    ...
    useEffect(() => {
        fetch("https://sheltered-shelf-11317.herokuapp.com/manageallorder")
            .then((res) => res.json())
    ...
    const handleDelete = (id) => {
        ...
        if (proceed) {
            fetch(
                `https://sheltered-shelf-11317.herokuapp.com/mybooking/${id}`,
                {
                    method: "DELETE",
                }
            )
    ...
    const handleUpdate = (id) => {
        ...
        const uri = `https://sheltered-shelf-11317.herokuapp.com/mybooking/${id}`;
        fetch(uri, {
            method: "PUT",
            headers: {
